...
const L_STRINGS = {
  es: {
    ...
    hero: {
      ...
      title: 'Facturar deja\nde ser una pelea.',
      subtitle: 'Invoxa centraliza las horas, los proyectos y las facturas de tu equipo creativo. Tú apruebas — el sistema entrega el PDF al cliente.',
      cta: 'Pedir acceso',
  ...
  en: {
    ...
    hero: {
      eyebrow: 'INVOXA · BY INFORMAGE STUDIOS',
      title: 'Billing stops\nbeing a fight.',
      subtitle: 'Invoxa centralizes hours, projects and invoices for your creative team. You approve — the system delivers the PDF to the client.',
      cta: 'Request access',
    ...
    how: {
      ...
      user: {
        role: 'Collaborator', name: 'Ricardo',
        actions: [
